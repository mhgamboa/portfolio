            ...
            {actions.map(({ href, text, primary }) => (
              <a
                className={classNames(
                  "flex gap-x-2 rounded-full border-2 bg-none px-4 py-2 text-sm font-medium text-white ring-offset-gray-700/80 duration-500 hover:bg-gray-700/80 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-base",
